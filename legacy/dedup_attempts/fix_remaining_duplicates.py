...
# Identifica casos específicos que precisam de merge
print("Procurando casos adicionais que precisam de merge...")
...
print(f"Encontrados {len(duplicates_found)} casos adicionais de duplicação:")
...
if duplicates_found:
    print("\nFazendo merge dos duplicados adicionais...")
    ...
    print(f"Jogadores merged adicionais: {len(merged_rows)}")
    ...
    print("Nenhum caso adicional de duplicação encontrado.")
