#atualiza o arquivo wout_data.csv com os jogadores que não têm dados de performance
import pandas as pd

def atualizar_wout_data():
    """
    Atualiza o arquivo wout_data.csv com os jogadores que realmente não têm dados de performance
    """
    
    # Caminho do arquivo melhorado
    arquivo_entrada = r"C:\Users\IGOR\Desktop\UFSC\TCC\dados\clubes\outcome\atletas_completo_melhorado_2024.csv"
    arquivo_saida = r"C:\Users\IGOR\Desktop\UFSC\TCC\dados\clubes\outcome\wout_data_atualizado.csv"
    
    print("Carregando arquivo melhorado...")
    ...
    colunas_principais = [
        ...
        'Height', 'Nation', 'Ex_Club_Limpo', 'Transferencia', 
    ...
    # Salvar arquivo
    print(f"\nSalvando arquivo atualizado: {arquivo_saida}")
...
if __name__ == "__main__":
    df_resultado = atualizar_wout_data()
